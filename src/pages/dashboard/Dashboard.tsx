      ...
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-soft p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <OriginCard
              platform="Google"
              icon={<div className="w-6 h-6 bg-gradient-to-r from-yellow-400 to-red-500 rounded-lg flex items-center justify-center text-white text-xs font-bold">G</div>}
              value={formatCounter(210)}
              percentage="7"
