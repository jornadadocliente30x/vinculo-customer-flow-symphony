...
const initialUsers: User[] = [
  { id: 1, name: 'Paulo Barreto', email: 'paulo@vinculo.com', phone: '(11) 99999-9999', type: 'Administrador' },
  { id: 2, name: 'Maria Silva', email: 'maria@vinculo.com', phone: '(11) 88888-8888', type: 'Cliente' },
  { id: 3, name: 'João Souza', email: 'joao@vinculo.com', phone: '(11) 77777-7777', type: 'Cliente' },
];
